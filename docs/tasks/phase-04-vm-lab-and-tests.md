...
3. Test-lab docs explain how to repeat phase 01-02 validation now, with phase 03 extension explicitly deferred.
...
4. `tests/nat-lab/README.md` documents prerequisites, environment variables, and repeat steps.

Verification:

1. `bash -n tests/nat-lab/common.sh tests/nat-lab/create-lab.sh tests/nat-lab/destroy-lab.sh tests/nat-lab/run-phase01-02.sh`
